...
public class UIKitRelativeLayout extends RelativeLayout implements UIKitComponent {

    private static final String TAG = "UIKitRelativeLayout";
    ...
    public UIKitRelativeLayout(Context context) {
        super(context);
    }
    ...
    public UIKitRelativeLayout attachViewBlock(AttributeSet attrs) {
        mUiKitHelper.attachViewBlock(this, attrs);
        return this;
    }

    public UIKitRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public UIKitRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public UIKitRelativeLayout setViewBlockManager(ViewBlockManager viewBlockManager) {
    ...
    public UIKitRelativeLayout setParent(ViewGroup mParent) {
